const remittanceData = window.remittanceData || [];
const remitFrequentAccounts = window.remitFrequentAccounts || [];
const remitRecentAccounts = window.remitRecentAccounts || [];
